...
wget https://github.com/snort3/snort3/archive/refs/tags/3.0.3-6.tar.gz -O snort3.tar.gz
wget https://github.com/google/flatbuffers/archive/v1.12.0.tar.gz -O flatbuffers-v1.12.0.tar.gz
wget https://codeload.github.com/snort3/libdaq/tar.gz/refs/tags/v3.0.3 -O libdaq-3.0.3.tar.gz